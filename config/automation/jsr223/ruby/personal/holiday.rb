...
rule "decorations on at sunset" do
  ...
  run do
    ...
    program = Holiday_Mode == "Christmas" ? WifiLED::Program::RED_GREEN_CROSSFADE : WifiLED::Program::PURPLE_FADE
    ...
    if Zoom_Active_Switch.off? && Office_Door_LED_Program != program
      Office_Door_LED_Program << program
    end
  ...
  only_if { %w/Christmas Halloween/.include?(Holiday_Mode) }
end
