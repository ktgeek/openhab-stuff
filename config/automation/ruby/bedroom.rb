...
channel(%w[1_single 2_single 3_single], thing: BEDROOM_REMOTES) do |event|
  ...
  Bedroom_Ceiling_Fan_Speed.ensure.command(speed)
end

channel(%w[1_double 2_double 3_double], thing: BEDROOM_REMOTES) do
  Bedroom_Ceiling_Fan_Speed.ensure.command(0)
end
...
channel("4_double", thing: BEDROOM_REMOTES) { Bedroom_Ceiling_Fan_Light.toggle }
...
updated(Bedroom_Hallway_Light_Scene_3, to: ZWave::Paddle::CLICK) do
  if Bedroom_Ceiling_Fan_Speed.on?
    Bedroom_Ceiling_Fan_Speed.command(0)
  else
    Bedroom_Ceiling_Fan_Speed.command(100)
  end
end

updated(Bedroom_Hallway_Light_Scene_4, to: ZWave::Paddle::CLICK) { Bedroom_Hallway_Light_Switch.toggle }

updated(Bedroom_Hallway_Light_Scene_5, to: ZWave::Paddle::CLICK) { Bedroom_Ceiling_Fan_Light.toggle }
